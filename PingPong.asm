...
;design
ball: dw 0x0C6F 		; character used to represent the ball
paddle1: dw 0x0DB2		; character used to build paddle1
paddle2: dw 0x0EB2		; character used to build paddle2
...
message1 : db 'Enter Name of Player 1 : '
message2 : db 'Enter Name of Player 2 : '
messageL : dw 25
getNameInput:
	pushAD
	push es
